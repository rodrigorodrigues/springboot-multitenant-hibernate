...
insert into test.person (id, tenant, name) values(NEXTVAL('test.person_seq'), 'CustomerA', 'Test Customer A - Postgresql');
insert into test.person (id, tenant, name) values(NEXTVAL('test.person_seq'), 'CustomerB', 'Test Customer B - Postgresql');
